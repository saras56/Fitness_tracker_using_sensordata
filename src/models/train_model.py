...
# Forward selection for classification which selects a pre-defined 
# number of features (max_features) that show the best accuracy. 
# We assume a decision tree learning for this purpose, but
...
# random forest with feature set 4 gives the best result
